...
class JAction {
    ...
    getPEle(this: JMain, op: { pos: number[], show: string, color?: string, fontSize?: number | string, viewW: number, viewH: number, fontweight?: number | string; }) {
        ...
        op.fontweight && (p.style.fontWeight = op.fontweight.toString());
